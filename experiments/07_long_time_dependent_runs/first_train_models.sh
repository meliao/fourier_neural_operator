...
#SBATCH --error=experiments/07_long_time_dependent_runs/logs/00_time_dep.err
...
--model_fp experiments/07_long_time_dependent_runs/models/00_time_dep_ep_{} \
--train_df experiments/07_long_time_dependent_runs/results/00_time_dep_train.txt \
