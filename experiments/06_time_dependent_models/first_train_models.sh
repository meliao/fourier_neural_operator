...
#SBATCH --output=experiments/06_time_dependent_models/logs/00_test_job.out
#SBATCH --error=experiments/06_time_dependent_models/logs/00_test_job.err
...
--model_fp experiments/06_time_dependent_models/models/test_model_00 \
--results_fp experiments/06_time_dependent_models/results/test_results.txt \
--train_df experiments/06_time_dependent_models/results/test_train_00.txt \
--freq_modes 8 \
--time_subsample 100
