...
STEP_SIZE = 0.001;
GAMMA = -1;
FP_OUT = '/home/owen/2021_Spring_Courses/Becca_Reading_Group/NLS_solver/data/2021-06-04_Matlab_NLS_data.mat';


PLOT_DIR = '/home/owen/projects/fourier_neural_operator/data/2021-06-04_training_data_test_plots/';
...
for i=1:N_TRAINING_EXAMPLES
  IC = random_IC_sin_cos(X_BOUNDS, MAX_IC_FREQ, i);
